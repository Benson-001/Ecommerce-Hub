    ...
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[50px]">
      <div className="flex justify-between py-[5%]">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="mt-2">254  Alnour Plaza Ave, Malindi, Kenya</p>
          <p className="mt-2">Phone: (254) 740-548-173</p>
          <p className="mt-2">Email: benfuraha2017@gmail.com</p>
        </div>
      </div>
      <div className="mt-8 border-t border-[#e9acd9] pt-4 text-center">
        <p>&copy; 2024 Belene Beauty & Wellness Hub. All rights reserved.</p>
